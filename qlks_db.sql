...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 06, 2021 lúc 11:14 AM
...
--
ALTER TABLE `bang_kiem_tra_dinh_ki`
  MODIFY `MA_KT_DK` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
--
ALTER TABLE `datcoc`
  MODIFY `MA_DATCOC` int(10) NOT NULL ;

--
-- AUTO_INCREMENT cho bảng `dv`
--
ALTER TABLE `dv`
  MODIFY `MA_DV` int(10) NOT NULL ;

--
-- AUTO_INCREMENT cho bảng `hoadon_thanhtoanphong`
--
ALTER TABLE `hoadon_thanhtoanphong`
  MODIFY `MA_HD_TTP` int(10) NOT NULL;

--
-- AUTO_INCREMENT cho bảng `khachhang`
--
ALTER TABLE `khachhang`
  MODIFY `MAKH` int(10) NOT NULL ;
...
--
ALTER TABLE `nhanvien`
  MODIFY `MANV` int(10) NOT NULL ;

--
-- AUTO_INCREMENT cho bảng `phieuthuephong`
--
ALTER TABLE `phieuthuephong`
  MODIFY `MA_PT` int(10) NOT NULL ;

--
-- AUTO_INCREMENT cho bảng `phieu_dv`
--
ALTER TABLE `phieu_dv`
  MODIFY `MAPHIEUDV` int(10) NOT NULL ;
...
--
ALTER TABLE `taikhoan`
  MODIFY `MATK` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;

--
-- AUTO_INCREMENT cho bảng `thiet_bi`
--
ALTER TABLE `thiet_bi`
  MODIFY `MA_THIETBI` int(10) NOT NULL;
