...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 15, 2021 lúc 03:11 PM
...
INSERT INTO `khachhang` (`MAKH`, `TENKH`, `GIOITINH`, `DIACHI`, `NGAYSINH`, `SDT`, `CMND`, `QUOCTICH`, `NGAYCHECK_IN`) VALUES
(1, 'Phú Lâm Hung', NULL, NULL, NULL, 209523, '123', NULL, NULL),
(2, 'qwe', NULL, NULL, NULL, 123, 'qwe', NULL, NULL),
(3, 'qwe', NULL, NULL, NULL, 123123, '23123123', NULL, NULL),
(4, 'tấn tới', 'nam', 'HCM', '2000-10-06', 0, '000000', 'VN', NULL),
(5, 'PHU', 'NU', 'HCM', '2000-11-01', 0, '2131212', 'VN', '2020-04-15');
