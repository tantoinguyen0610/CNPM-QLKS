...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 03, 2021 lúc 02:02 PM
...
(1, 'qwe', NULL, NULL, NULL, 123, 'qwe', NULL),
(2, 'qwe', NULL, NULL, NULL, 123123, 'qweqe', NULL),
(3, 'Phú', NULL, NULL, NULL, 123123, '123', NULL),
(4, 'qwe', NULL, NULL, NULL, 213, 'qwe', NULL),
(5, 'qwe', NULL, NULL, NULL, 123123, 'wq', NULL),
(6, 'wqe', NULL, NULL, NULL, 123, 'wqe', NULL),
(7, 'qwe', NULL, NULL, NULL, 123, 'wqe', NULL),
(8, 'qwe', NULL, NULL, NULL, 123, 'wqe', NULL),
(9, 'qwe', NULL, NULL, NULL, 123, 'qwe', NULL);
...
(1, NULL, NULL, NULL, '2021-04-01', 'qwe', '2021-04-22', 2, 'Deluxe', NULL, 2),
(2, NULL, NULL, NULL, '2021-03-31', 'qwe', '2021-04-13', 2, 'Superior', NULL, NULL),
(3, NULL, NULL, NULL, '2021-04-01', 'we', '2021-04-16', 2, 'Standard', NULL, 1),
(4, NULL, NULL, NULL, '2021-04-01', 'wqe', '2021-04-08', 2, 'Standard', NULL, 1),
(5, NULL, NULL, NULL, '2021-04-01', 'qwe', '2021-04-08', 2, 'Standard', NULL, 1),
(6, NULL, NULL, NULL, '2021-04-01', 'wqe', '2021-04-08', 2, 'Standard', NULL, 2),
(7, NULL, NULL, NULL, '2021-04-01', '2', '2021-04-15', 2, 'Standard', NULL, 2),
(8, NULL, NULL, NULL, '2021-04-01', '2', '2021-04-15', 2, 'Standard', NULL, 2),
(9, NULL, NULL, NULL, '2021-03-31', 'sad', '2021-04-08', 2, 'Standard', NULL, 1);
...
CREATE TABLE `phong` (
  ...
  `SONGUOIHIENTAI` int(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `phieuthuephong`
  MODIFY `MA_PT` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
