...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 26, 2021 lúc 09:21 AM
...
(4, 4, 4, 4, 'qweqwe', '2021-04-02', 500000, '0', 1000000, 'Đã Thanh Toán'),
(5, 5, 5, 5, 'qweqwe', '2021-04-01', 500000, '80000.0', 1080000, 'Đã Thanh Toán'),
(12, 12, 12, 12, 'qweq', '2021-04-02', 500000, '0', 1000000, 'Đã Thanh Toán');
...
('', NULL, NULL, 'Nâng Cấp Phòng', '102', NULL, 'wqeqwe', '2021-04-01', '2021-04-17', 'wqeqwe', 1231231, 432423, 'Đã Thanh Toán'),
...
CREATE TABLE `phieu_dv` (
  ...
  `SOPHONG` int(20) DEFAULT NULL,
  `TENDV` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `SOLUONG` int(20) DEFAULT NULL,
  `TONGTIENDV` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `phieu_dv`
--

INSERT INTO `phieu_dv` (`MAPHIEUDV`, `SOPHONG`, `TENDV`, `SOLUONG`, `TONGTIENDV`) VALUES
(1, 101, '7up', 6, '60000'),
(2, 101, 'buffet sáng', 2, '1000000'),
(3, 104, 'coca', 8, '80000');
...
INSERT INTO `taikhoan` (`MATK`, `USERNAME`, `PSW`, `CHUCVU`) VALUES
(1, 'quanly001', '123', 'Quản Lý'),
(2, 'letan001', '123', 'Lễ Tân'),
(3, 'ketoan001', '123', 'Kế Toán');
